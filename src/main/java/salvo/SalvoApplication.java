...
public class SalvoApplication {
    ...
    public CommandLineRunner initData(PlayerRepository players, GameRepository games, ShipRepository ships, GamePlayerRepository gamePlayers,
        ...
        return (args) -> {
            ...
            Ship ship1_4 = new Ship(gp1, Arrays.asList("I2", "I3", "I4", "I5", "I6"), "Aircraft Carrier");
            ...
            Ship ship2_4 = new Ship(gp2, Arrays.asList("E2", "F2", "G2", "H2", "I2"), "Aircraft Carrier");
