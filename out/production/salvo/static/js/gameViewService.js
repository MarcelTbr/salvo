...
/*
angular.module('myService', []).factory("myFactoryTest", function(){
...
.factory('updateGameView', function(){

return {
    getShipLocations : function(ships_array){
  ...
  getEnemies : function (enemies){
    ...
    allUserSalvoes : function(salvoes_obj) {
        var all_salvoes = [];
    ...
    getHitsArray : function (all_salvoes, enemies) {
            var hits = [];
